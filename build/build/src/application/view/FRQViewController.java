...
public class FRQViewController implements FrameUpdate{
	...
	public FRQViewController() {
		/*
		width = frameSettings.getOriWidth();
		hight = frameSettings.getOriHight();
		*/
	...
	private void initialize() {
		...
		cBox.getItems().addAll("DEFAULT", "AUTUMN", "BONE", "JET", "WINTER", "RAINBOW", "OCEAN", "SUMMER", "SPRING", "COOL", "HSV", "PINK", "HOT", "PARULA");
